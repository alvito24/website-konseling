            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('konseling.store') }}" class="space-y-6">
                        ...
                        <!-- Jenis Konseling -->
                        <div>
                            <label for="jenis_konseling" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Jenis Konseling
                            </label>
                        ...
                        <div>
                            <label for="waktu" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Waktu yang Diinginkan
                            </label>
